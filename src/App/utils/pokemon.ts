...
const BattlePokedex: Record<string, unknown> = {
  mebiusanpast: {
    num: 0,
  ...
  alcremierainbowswirl: {
    num: 869,
    species: 'Alcremie-Rainbow-Swirl',
    forme: 'Rainbow-Swirl',
    types: ['Fairy'],
    baseStats: { hp: 65, atk: 60, def: 75, spa: 110, spd: 121, spe: 64 },
    abilities: { 0: 'Sweet Veil', H: 'Aroma Veil' },
  ...
  alcremiecaramelswirl: {
    num: 869,
    species: 'Alcremie-Caramel-Swirl',
    forme: 'Caramel-Swirl',
    types: ['Fairy'],
    baseStats: { hp: 65, atk: 60, def: 75, spa: 110, spd: 121, spe: 64 },
    abilities: { 0: 'Sweet Veil', H: 'Aroma Veil' },
...
const POKEMON: Map<string, unknown> = new Map(Object.entries(BattlePokedex));
