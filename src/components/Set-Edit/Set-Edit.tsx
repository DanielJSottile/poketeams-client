...
const SetEdit = (props: any) => {
  ...
  const setShiny = () => {
    setState(oldVals => ({...oldVals, shiny: {value: !state.shiny.value, touched: true}}));
  };
  ...
  const validateNickname = (): any => { // Will some day check against Legal Nintendo filter!
  ...
  const validateItem = (): any => { // Will some day check against list of Items!
  ...
  const validateAbility = (): any => { // Will some day check against list of Abilities!
  ...
  const validateNature = (): any => { // Will some day check against list of Natures!
  ...
  const validateShiny = (): any => { // Normally this would be put against a legal Shiny list, but my custom game eliminates this.
  ...
  const validateGender = (): any => { // does this work?
  ...
  const validateLevel = (): any => { // in the future, Custom Game might be integrated.  Not sure what the max level is there.
  ...
  const validateMoves = (): any => { // Every Pokemon has at least 1 move.  Only one we actually need to check for
        ...
        <form> 
            ...
            <div className="name-sprite">
              <div className="names">
                ...
                <input className="pokemon-gender" placeholder="F, M, or N" value={state.gender.value} onChange={e => setGender(e.target.value)} type="text" name="pokemon-gender" id={`pokemon-gender-${set.id}`} />
                  <div>
                    ...
                    <input type="checkbox" id="shiny-2" name="shiny" checked={state.shiny.value} value={state.shiny.value.toString()} onChange={e => setShiny()}/>
                  </div>  
              </div>
              <div className="sprites">
                ...
                <div className="type-icons">
                  {legality.returnTypeIcon(legality.returnType(state.species.value)).map((type: any, i: number)=> {
          ...
          <div className="details">
            <div className="first-details">
              ...
              <input className="pokemon-level" placeholder="100" value={state.level.value} onChange={e => setLevel(Number(e.target.value))} type="text" name="pokemon-level" id={`pokemon-level-${set.id}`} />
              ...
              <input className="pokemon-happiness" placeholder="255" value={state.happiness.value} onChange={e => setHappiness(Number(e.target.value))} type="number" name="pokemon-happiness" min="0" max="255" id={`pokemon-happiness-${set.id}`} />
            </div>
            <div className="stats">
              <div className="evs">
              {<p className="error-validate shake-horizontal">{validateEvs()}</p>}
                <label htmlFor="pokemon-ev-hp">HP EV:</label>
                <input className="pokemon-ev" placeholder="0" value={Number(state.hp_ev.value)} onChange={e => setHpEv(Number(e.target.value))} type="number" name="pokemon-ev-hp" min="0" max="252" id={`pokemon-ev-hp-${set.id}`} />
                <label htmlFor="pokemon-ev-atk">Atk EV:</label>
                <input className="pokemon-ev" placeholder="0" value={Number(state.atk_ev.value)} onChange={e => setAtkEv(Number(e.target.value))} type="number" name="pokemon-ev-atk" min="0" max="252" id={`pokemon-ev-atk-${set.id}`} />
                <label htmlFor="pokemon-ev-def">Def EV:</label>
                <input className="pokemon-ev" placeholder="0" value={Number(state.def_ev.value)} onChange={e => setDefEv(Number(e.target.value))} type="number" name="pokemon-ev-def" min="0" max="252" id={`pokemon-ev-def-${set.id}`} />
                <label htmlFor="pokemon-ev-spa">SpA EV:</label>
                <input className="pokemon-ev" placeholder="0" value={Number(state.spa_ev.value)} onChange={e => setSpAEv(Number(e.target.value))} type="number" name="pokemon-ev-spa" min="0" max="252" id={`pokemon-ev-spa-${set.id}`} />
                <label htmlFor="pokemon-ev-spd">SpD EV:</label>
                <input className="pokemon-ev" placeholder="0" value={Number(state.spd_ev.value)} onChange={e => setSpDEv(Number(e.target.value))} type="number" name="pokemon-ev-spd" min="0" max="252" id={`pokemon-ev-spd-${set.id}`} />
                <label htmlFor="pokemon-ev-spe">SpE EV:</label>
                <input className="pokemon-ev" placeholder="0" value={Number(state.spe_ev.value)} onChange={e => setSpeEv(Number(e.target.value))} type="number" name="pokemon-ev-spe" min="0" max="252" id={`pokemon-ev-spe-${set.id}`} />
              </div>
              <div className="ivs">
              {<p className="error-validate shake-horizontal">{validateIvs()}</p>}
                <label htmlFor="pokemon-iv-hp">HP IV:</label>
                <input className="pokemon-iv" placeholder="31" value={Number(state.hp_iv.value)} onChange={e => setHpIv(Number(e.target.value))} type="number" name="pokemon-iv-hp" min="0" max="31" id={`pokemon-iv-hp-${set.id}`} />
                <label htmlFor="pokemon-iv-atk">Atk IV:</label>
                <input className="pokemon-iv" placeholder="31" value={Number(state.atk_iv.value)} onChange={e => setAtkIv(Number(e.target.value))} type="number" name="pokemon-iv-atk" min="0" max="31" id={`pokemon-iv-atk-${set.id}`} />
                <label htmlFor="pokemon-iv-def">Def IV:</label>
                <input className="pokemon-iv" placeholder="31" value={Number(state.def_iv.value)} onChange={e => setDefIv(Number(e.target.value))} type="number" name="pokemon-iv-def" min="0" max="31" id={`pokemon-iv-def-${set.id}`} />
                <label htmlFor="pokemon-iv-spa">SpA IV:</label>
                <input className="pokemon-iv" placeholder="31" value={Number(state.spa_iv.value)} onChange={e => setSpAIv(Number(e.target.value))} type="number" name="pokemon-iv-spa" min="0" max="31" id={`pokemon-iv-spa-${set.id}`} />
                <label htmlFor="pokemon-iv-spd">SpD IV:</label>
                <input className="pokemon-iv" placeholder="31" value={Number(state.spd_iv.value)} onChange={e => setSpDIv(Number(e.target.value))} type="number" name="pokemon-iv-spd" min="0" max="31" id={`pokemon-iv-spd-${set.id}`} />
                <label htmlFor="pokemon-iv-spe">SpE IV:</label>
                <input className="pokemon-iv" placeholder="31" value={Number(state.spe_iv.value)} onChange={e => setSpeIv(Number(e.target.value))} type="number" name="pokemon-iv-spe" min="0" max="31" id={`pokemon-iv-spe-${set.id}`} />
              </div>
            </div>
            <div className="moves">
