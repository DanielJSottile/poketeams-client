...
const TeamsButtonListEdit = (props: any) => {
  ...
  const renderExpanded = () => {
    ...
    return (
      <form>
        ...
        <div className="team-import">
          ...
          <textarea placeholder="e.g. description" name="title-content" id="title-content" value={desc.value} onChange={e => setDesc(e.target.value)}/>
        </div>
        <div className="team-import">
          ...
          <textarea placeholder="Optionally Import a proper Pokemon Showdown Team Here And It Will Fill Out Your Whole Team!" name="team-import" id="team-import-1" value={newTeamImport.value} onChange={e => setNewTeamContents(e.target.value)}></textarea>
        </div>
        <button type="submit"
        className="submit"
        disabled={
    ...
    .map((team: PokemonTeam, i: number) => <TeamButton key={i} id={team.id} team_name={team.team_name}/>);
