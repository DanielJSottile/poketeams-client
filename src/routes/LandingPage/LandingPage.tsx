...
const LandingPage = (props: any): JSX.Element => {
  ...
  const handleLoginSucess = (): void => {
    ...
    return ( // make this JSX into a component!
      <Fragment>
          <header role="banner">
          ...
          <section>
            ...
            <p>PokeTeams goes above and beyond the average pastebin in order for you to import, save, 
          ...
          <section>
            ...
            <p>Once you've uploaded your teams, you'll be able to edit them by hand or by importing
          ...
          <section>
            ...
            <p>PokeTeams lets you search the database by specific Pokemon species, alphabetical order
               and date created.  In the future, you'll be able to search for specific teams
              and by popularity!
            </p>
          </section>
          <section>
            ...
            <p>Most importantly, you can share both full teams and Pokemon sets with anyone! Create awesome
